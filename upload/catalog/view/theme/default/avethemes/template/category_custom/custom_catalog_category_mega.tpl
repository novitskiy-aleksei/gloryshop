...
<ul class="sidebar-menu list-group vertical-mega-menu">
  ...
  ?>
    ...
    <li class="<?php echo $active_class;?>"><a href="<?php echo $category['href']; ?>" class="vview" data-id="vcate<?php echo $category['category_id']; ?>"><?php echo $icon;?> <?php echo $category['name']; ?> <?php echo $category['count']; ?> <?php echo $arrow;?></a>
      ...
      <div class="mega-menu <?php echo $vcolumn;?> <?php if($show_thumb){?>with-preview<?php } ?>">
          ...
          <div class="header-navigation-preview">
                            ...
                            <div class="gallery-item vcate<?php echo $category['category_id']; ?>" data-relate="vcate<?php echo $category['category_id']; ?>">
                           ...
                           <?php foreach ($category['level_1'] as $level_1) { ?>
                                     <div class="gallery-item vcate<?php echo $level_1['category_id']; ?>" data-relate="vcate<?php echo $level_1['category_id']; ?>">
                                     ...
                                     <?php if ($level_1['level_2']) { ?>
                                               <?php foreach ($level_1['level_2'] as $level_2) { ?>
                                                         <div class="gallery-item vcate<?php echo $level_2['category_id']; ?>" data-relate="vcate<?php echo $level_2['category_id']; ?>">
          ...
          <h4 class="top_parent vview" data-id="vcate<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></h4>
        <ul>
          <?php foreach ($category['level_1'] as $level_1) { 
          ...
          ?>
              <li>
                <ul>
                  <li class="<?php echo $third_parent;?>"><a href="<?php echo $level_1['href']; ?>" class="vview vcate<?php echo $level_1['category_id']; ?>" data-id="vcate<?php echo $level_1['category_id']; ?>"><?php echo $level_1['name']; ?> <?php echo $level_1['count']; ?></a></li>
            <?php if($level_1['level_2']) { ?>
                  <?php foreach ($level_1['level_2'] as $level_2) { ?>
                    <li><a class="vview vcate<?php echo $level_2['category_id']; ?>" href="<?php echo $level_2['href']; ?>" data-id="vcate<?php echo $level_2['category_id']; ?>"><i class="fa fa-angle-right"></i> <?php echo $level_2['name'] ?>  <?php echo $level_2['count']; ?></a></li>
                  <?php } ?>
            <?php } ?>
                </ul>
              </li>
