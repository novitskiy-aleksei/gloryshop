    ...
    <ul class="list-group sidebar-menu">
     <?php foreach ($categories as $category) { ?>
              <?php
                ...
                $dropdown_u=($category['category_id'] == $category_id)?'display:block;':' ';
                $category_active = ($category['category_id'] == $category_id)?'active':'';
                $link_active = ($category['category_id'] == $category_id)?'collapsed':'';
                 ?>
                <li class="list-group-item <?php echo $category_active;?> <?php echo $dropdown_li;?>">
                <a href="<?php echo $category['href']; ?>" class="<?php echo $link_active;?>"><i class="fa fa-angle-right"></i><?php echo $category['name']; ?><?php echo $dropdown_angle;?> <?php echo $category['count']; ?></a>
                <?php if ($category['level_1']) { ?>
                <ul class="dropdown-menu" style="<?php echo $dropdown_u;?>">                  
                  <?php foreach ($category['level_1'] as $level_1) {?>
                    <?php
                     $li_1_active= ($level_1['category_id'] == $child_id)?'active':''; 
                     $link_1_active= ($level_1['category_id'] == $child_id)?'collapsed':''; 
                     $child_1_active= ($level_1['category_id'] == $child_id)?'active':''; 
                    ?>
                ...
                <?php echo $level_1['count']; ?>
                    ...
                    <?php if ($level_1['level_2']) { ?> 
                          ...
                          <?php foreach ($level_1['level_2'] as $level_2) {?> 
                                 <?php
                                     $li_2_active= ($level_2['category_id'] == $child_2_id)?'active':''; 
                                     $link_2_active= ($level_2['category_id'] == $child_2_id)?'collapsed':''; 
                                     $child_2_active= ($level_2['category_id'] == $child_2_id)?'active':''; 
                                    ?>
                                ...
                                <li class="<?php echo $level_2_with_class;?> <?php echo $li_2_active;?> ">
                                    ...
                                    <?php echo $level_2['count']; ?>
                                        ...
                                        <?php if ($level_2['level_3']) { ?> 
                                              ...
                                              <?php
                                                 $li_3_active= ($level_3['category_id'] == $child_3_id)?'active':''; 
                                                ?>
