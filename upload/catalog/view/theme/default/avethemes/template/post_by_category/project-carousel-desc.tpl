...
<div id="<?php echo $module;?>_<?php echo $category['tab_id'];?>" class="elem_item_grid post-layout owl-carousel carousel-nav-<?php echo $carousel_nav;?> project_text_nav boxed_portos upper_title">
