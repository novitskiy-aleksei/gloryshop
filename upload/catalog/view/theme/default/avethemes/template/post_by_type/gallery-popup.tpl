...
<?php echo !empty($bgimage)?'background-image: url(image/'.$bgimage.');':''?>">
    ...
    <div class="content_row elem_item_grid clearfix lightbox_gallery" data-options="{attr:&#39;data-source&#39;,path:&#39;horizontal&#39;,skin:&#39;smooth&#39;}">
    ...
    <div class="item_list_block animated" data-animation-delay="300" data-animation="<?php echo $animation;?>">
            <div class="item_image">
                <div class="item_image_corners">
                    ...
                    <a href="<?php echo $article['popup']; ?>" data-source="<?php echo $article['popup']; ?>" data-caption="<?php echo $article['name'];?>"  title="<?php echo $article['name'];?>">
