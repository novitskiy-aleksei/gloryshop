...
?>
    ...
    <?php if(!empty($description)){?><p class="main_desc centered"><?php echo $description;?></p><?php } ?>
		    ...
		    <div class="isotope_filter_wrapper blocks_<?php echo ($carousel_limit<2||$carousel_limit>4)?'3':$carousel_limit;?> project_text_nav boxed_portos has_sapce_portos nav_with_nums upper_title upper_title">
