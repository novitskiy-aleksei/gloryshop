			...
			<div class="content clearfix">
				...
				<div class="top_details clearfix pull-right">
					...
					<div id="top-account" class="dropdown-select dropdown-drop">
						<span><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>"><i class="icon fa fa-user"></i><span class="title"><?php echo $text_account; ?></span></a>&nbsp;<i class="fa fa-angle-down"></i></span>
