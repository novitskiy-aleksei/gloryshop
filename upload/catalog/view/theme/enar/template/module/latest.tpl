...
<div id="latest_module<?php echo $module;?>" class="elem_item_grid owl-carousel carousel-nav-top product-layout">
...
<div class="item_list_block ">
        <div class="item_image">
            ...
            <div class="item_img">
             ...
             <?php }else{ ?>
            <span class="ribbon_label">
                <span class="ribbon_text"><?php echo $ave->text('latest_label');?></span><span class="ribbon_circle latest_bg"></span>
            </span>
             <?php } ?>
...
$('#latest_module<?php echo $module;?>').owlCarousel({
		margin: 20,
		loop: false,
