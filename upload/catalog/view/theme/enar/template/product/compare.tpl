...
<?php echo $column_left; ?>
        ...
        <div class="heading_title centered upper">
				<h2><span class="line"><i class="fa fa-exchange"></i></span><?php echo $heading_title; ?></h2>
		</div>
      <?php if ($products) { ?>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
           ...
           <?php foreach ($products as $product) { ?>
        <td class="rating"><div class="item-rating" title="<?php echo $products[$product['product_id']]['reviews']; ?>"><span class="star-<?php echo $products[$product['product_id']]['rating']; ?>"></span></div><br /><br />
        ...
        <tr>
          ...
          <?php foreach ($products as $product) { ?>
          <td>
          <button type="button" class="btn btn-primary btn-block" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><?php echo $button_cart; ?></button>
