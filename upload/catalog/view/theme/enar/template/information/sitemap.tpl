...
<?php echo $column_left; ?>
        ...
        <div class="heading_title centered upper">
				<h2><span class="line"><i class="fa fa-folder-open-o"></i></span><?php echo $heading_title; ?></h2>
		</div>
      <div class="row site-map">
        <div class="col-sm-<?php echo isset($content_sitemap)?'4':'6';?>  col-xs-12">
        <h3><?php echo $ave->text('text_catalog');?></h3>
          <ul>
          ...
          <?php echo $content_sitemap;?>
        <div class="col-sm-<?php echo isset($content_sitemap)?'4':'6';?>  col-xs-12">
        	<h3><?php echo $ave->text('text_extras');?></h3>
          <ul>
           ...
           <h3><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a></h3>
            ...
            <h3><?php echo $text_information; ?></h3> <ul>
