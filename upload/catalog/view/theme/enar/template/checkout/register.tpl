...
<div class="buttons clearfix">
  <div class="pull-left">
    <button type="button" class="btn btn-primary" id="back-checkout-option" >Back</button>
  </div>
  <div class="pull-right">
<?php if ($text_agree) { ?><label> <input type="checkbox" name="agree" value="1" /> &nbsp;<?php echo $text_agree; ?></label> &nbsp;<?php } ?>
