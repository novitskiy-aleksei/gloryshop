  ...
  <div id="collapse-shipping" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <form class="form-horizontal">
        ...
        <input type="button" value="<?php echo $button_quote; ?>" id="button-quote" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary pull-right" />
      </form>
		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('#content').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
			...
			if (json['shipping_method']) {
				...
				for (i in json['shipping_method']) {
					html += '<p><h5>' + json['shipping_method'][i]['title'] + '</h5></p>';
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				$('#content').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
