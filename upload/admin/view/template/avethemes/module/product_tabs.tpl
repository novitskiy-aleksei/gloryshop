      ...
      <div class="panel-body">
       ...
       <div class="row">
           ...
           <div class="form-group">
                <label class="col-sm-2 control-label" for="input-name"><?php echo $entry_product_type; ?></label>
...
<a class="btn btn-xs btn-success">
      ...
      <?php echo $product_tabs_label[$value]; ?></a>           
                
      <?php } ?>       
                </div>
                <input type="hidden" value="<?php echo $product_sort;?>" name="product_sort" />
              </div>  <!--//form-group-->   
       </div>  <!--//row-->   
       <div class="row">
    ...
    <option value="ave_parallax9" <?php echo ($paralax_class=='ave_parallax9')?'selected="selected"':'';?>>Paralax level 9</option> 
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="bgimage" value="<?php echo $bgimage;?>" id="main_image"/>
              ...
              <div class="form-group item_display otp-product-tab-grid">
 ...
 <input type="text" name="description_limit" id="description_limit" value="<?php echo $description_limit; ?>" class="form-control" />   
            ...
            <div class="form-group">
              ...
              <div class="form-group item_display otp-product-tab-grid otp-product-tab-grid-desc">
              ...
              <div class="form-group item_display otp-product-tab-grid-carousel otp-product-tab-grid-carousel-desc">
              ...
              <div class="form-group item_display otp-product-tab-grid-carousel otp-product-tab-grid-carousel-desc">
                ...
                <div class="form-group item_display otp-product-tab-grid-carousel otp-product-tab-list-carousel otp-product-tab-grid-carousel-desc">
            ...
            <div class="form-group item_display otp-product-tab-grid-carousel otp-product-tab-list-carousel otp-product-tab-grid-carousel-desc">
               ...
               <div class="form-group item_display otp-product-tab-grid-desc otp-product-tab-grid-carousel-desc">
	 	...
	 	if ($('.tabs_sort').length ) {
				$('.tabs_sort').each(function(index, elem) {
						...
						$('.tabs_sort').bind('sortupdate', function(event, ui) {						 
								...
								$('input[name=\'product_sort\']').attr('value', data.join());	
						});
				});
		}
	});
