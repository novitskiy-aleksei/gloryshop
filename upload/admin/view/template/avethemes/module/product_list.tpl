...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <button type="submit" form="form-product_list" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></span></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product_list" class="form-horizontal">
        <div class="row">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <div class="col-sm-12" for=""><?php echo $entry_item_display; ?></div>
            <div class="col-sm-12">             
 ...
 <select name="animation" class="form-control tr_change with-nav">  
   ...
   <?php } ?>
         ...
         <div class="autosuggest">
                ...
                <input type="text" name="filter_input" value="" class="form-control" placeholder="Filter here"/>
                </div>
                ...
                <?php if(!empty($parent_id)){                
                 foreach ($categories_group as $category) { 
                    ...
                    <div id="parent_id<?php echo $category['category_id']; ?>" class="<?php echo $class; ?>"><?php echo $category['name']; ?> <img src="../assets/theme/img/delete.png" alt="" onclick="$(this).parent().remove();"/>
                      <input type="hidden" name="parent_id[]" value="<?php echo $category['category_id']; ?>" />
                    </div>
                <?php } ?>
                <?php } ?>
              </div><!-- //scrollbox--> 
         ...
         <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="form-group item_display otp-product-grid otp-product-grid-desc otp-product-tab-grid">
          ...
          <div class="form-group item_display otp-product-carousel-grid otp-product-tab-grid-carousel otp-product-carousel-grid-desc">
            ...
            <select name="carousel_limit" class="form-control">  
               ...
               <div class="form-group item_display otp-product-carousel-grid otp-product-tab-grid-carousel otp-product-carousel-grid-desc otp-product-tab-list-carousel otp-product-list-carousel">
         ...
         <div class="form-group item_display otp-product-grid-desc otp-product-carousel-grid-desc otp-product-list-carousel-desc">
            ...
            <div class="form-group">
                ...
                <select name="sort_by" class="form-control">
                  ...
                  <option value="p.price" <?php echo ($sort_by=='p.price')?'selected="selected"':'';?>><?php echo $text_sort_price; ?></option>             
