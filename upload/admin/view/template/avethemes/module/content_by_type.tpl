...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <button type="submit" form="form-content_by_type" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></span></button>
   ...
   <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $text_error_install; ?>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-content_by_type" class="form-horizontal">
        <div class="row">
 ...
 <select name="animation" class="form-control tr_change with-nav">  
   ...
   <?php } ?>
           ...
           <div class="form-group">
                <label class="col-sm-4 control-label"><?php echo $entry_article_type; ?></label>
                <div class="col-sm-8">
                 <select name="article_type" id="article_type" onchange="Plus.activeObj('article_type',this.options[this.selectedIndex].value);" class="form-control tr_change with-nav">                
      <option value="recent_article"   <?php if ($article_type=='recent_article') { ?>selected="selected"<?php } ?>><?php echo $text_recent_article; ?></option>    
      <option value="most_viewed" <?php if ($article_type=='most_viewed') { ?>selected="selected"<?php } ?>><?php echo $text_most_viewed; ?></option>         
      <option value="random_post" <?php if ($article_type=='random_post') { ?>selected="selected"<?php } ?>><?php echo $text_random; ?></option>       
      <option value="custom_item" <?php if ($article_type=='custom_item') { ?>selected="selected"<?php } ?>><?php echo $text_custom_item; ?></option>  
      <option value="same_author" <?php if ($article_type=='same_author') { ?>selected="selected"<?php } ?>><?php echo $text_same_author; ?></option>         
                  
                </select>
                </div>
              </div>  <!--//form-group-->  
                
          <div class="form-group item_display otp-post-column-list">
            <label class="col-sm-4 control-label" for=""><?php echo $text_btn_more; ?></label>
            <div class="col-sm-8">
            <select name="btn_more" class="form-control">  
                  <option value="1" <?php echo($btn_more==1)?'selected="selected"':''; ?>><?php echo $text_yes;?> </option>
                  <option value="0" <?php echo($btn_more==0)?'selected="selected"':''; ?>><?php echo $text_no;?></option>             
                </select>  
            </div>
          </div><!--//form-group-->        
               ...
               <div class="form-group article_type otp-custom_item">
                ...
                <div class="col-sm-9">
                        <div class="autosuggest">
                            ...
                            <?php if(!empty($custom_item_articles)) {   ?>
                            <?php foreach ($custom_item_articles as $article) {             
          ...
          <div class="form-group hide">
            <label class="col-sm-4 control-label" for=""><?php echo $text_link_type; ?></label>
            <div class="col-sm-8">
            <select name="link_type" class="form-control">  
                  <option value="link" <?php echo($link_type=='link')?'selected="selected"':''; ?>><?php echo $text_link;?> </option>
                  <option value="modalbox" <?php echo($link_type=='modalbox')?'selected="selected"':''; ?>><?php echo $text_popup;?></option>             
                </select>  
            </div>
          </div><!--//form-group-->  
          ...
          <div class="form-group">
           ...
           <div class="form-group item_display otp-post-carousel-grid otp-post-list-carousel otp-post-column-carousel otp-post-carousel-grid-desc otp-project-carousel otp-project-carousel-desc otp-gallery-carousel">
            ...
            <div class="form-group item_display otp-post-carousel-grid otp-post-list-carousel otp-post-carousel-grid-desc otp-project-carousel otp-project-carousel-desc otp-gallery-carousel">
              ...
              <div class="form-group item_display otp-post-grid otp-project-grid otp-project-grid-desc otp-gallery-grid otp-post-grid-desc otp-gallery-popup">
              ...
              <div class="form-group item_display otp-post-carousel-grid otp-project-carousel-desc otp-project-carousel otp-gallery-carousel otp-post-grid-desc otp-news-bar  otp-project-cover-photo otp-project-filter otp-project-filter-fullwidth">
