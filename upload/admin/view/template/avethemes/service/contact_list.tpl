          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-product"><?php echo $entry_email; ?></label>
                <input type="text" name="filter_email" value="<?php echo $filter_email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-product" class="form-control" />
              </div>
              <div class="form-group">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($review['contact_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $review['contact_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $review['contact_id']; ?>" />
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=feed/contact&token=<?php echo $token; ?>';
