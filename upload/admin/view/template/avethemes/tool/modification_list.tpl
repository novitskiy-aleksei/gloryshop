...
<a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
  ...
  <div class="container-fluid">
    ...
    <div class="alert alert-info"><i class="fa fa-info-circle"></i> <?php echo $text_refresh; ?>
     ...
     <form action="<?php echo $import_ocmod; ?>" method="post" enctype="multipart/form-data" id="import">
        ...
        <table class="table table-bordered table-hover">
                 <tbody>
                    ...
                    <td>
    <a onclick="$('#import').submit();" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <span>Import modification (Overwrite if modification 'unique code' exists)</span></a>
                    </td>   
                    </tr>
                    </tbody>
                    </table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        ...
                        <a href="<?php echo $modification['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                        <a href="<?php echo $modification['download']; ?>" data-toggle="tooltip" title="<?php echo $button_download; ?>" class="btn btn-success"><i class="fa fa-download"></i></a>
