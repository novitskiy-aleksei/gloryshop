			...
			<?php } ?>
              ...
              <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left"><?php echo $entry_image; ?></td><td class="text-left">Primary Image</td>
                  ...
                  <tbody>
                    ...
                    <tr class="image-row" id="image-row<?php echo $image_row; ?>">
                      ...
                      <td class="text-left"><input type="radio" name="primary_image" onclick="changePrimaryImage(<?php echo $image_row; ?>)"></td><td class="text-right"><input type="text" name="product_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $product_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control sort_order" /></td>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2"></td>
                      <td></td><td class="text-right"><button type="button" onclick="addImage();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
...
function addImage() {		
	...
	html  = '<tr class="image-row" id="image-row' + image_row + '">';
	...
	html += '<td class="text-left"><input type="radio" name="primary_image" onclick="changePrimaryImage(' + image_row + ')"/></td><td class="text-right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="' + image_row + '" placeholder="<?php echo $entry_sort_order; ?>" class="form-control sort_order" /></td>';
