        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-category">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  <td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td><td style="width:80px;" class="text-center">Image</td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($category['category_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if (isset($category['image'])) { ?><img src="<?php echo $category['image']; ?>" alt="<?php echo $category['name']; ?>" style="width: 80px;" class="img-thumbnail" /><?php } else { ?><span class="img-thumbnail list"><i class="fa fa-camera fa-2x"></i></span><?php } ?></td>
