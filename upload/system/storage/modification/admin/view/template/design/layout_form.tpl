            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    <option value="pre_header" <?php if ($layout_module['position'] == 'pre_header') { ?>selected="selected"<?php } ?>>Δ - Pre Header</option>
...
function addModule() {
    ...
    html += '<option value="pre_header">Δ - Pre Header</option>';
